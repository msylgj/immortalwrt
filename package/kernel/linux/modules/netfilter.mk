...
define KernelPackage/nft-offload
  ...
  KCONFIG:= \
	...
	CONFIG_NF_FLOW_TABLE_IPV4@lt5.19 \
	CONFIG_NF_FLOW_TABLE_IPV6@lt5.19 \
	CONFIG_NFT_FLOW_OFFLOAD
  FILES:= \
	$(LINUX_DIR)/net/netfilter/nf_flow_table_inet.ko \
	$(LINUX_DIR)/net/ipv4/netfilter/nf_flow_table_ipv4.ko@lt5.19 \
	$(LINUX_DIR)/net/ipv6/netfilter/nf_flow_table_ipv6.ko@lt5.19 \
	$(LINUX_DIR)/net/netfilter/nft_flow_offload.ko
  AUTOLOAD:=$(call AutoProbe,nf_flow_table_inet nf_flow_table_ipv4@lt5.19 nf_flow_table_ipv6@lt5.19 nft_flow_offload)
endef
